...
public class RegDSB extends javax.swing.JFrame {
    ...
    public RegDSB() {
        ...
        try (Connection cn = new DBConnector().getConnection()) {
            ...
            PreparedStatement checkerStmt = cn.prepareStatement("SELECT COUNT(*) FROM jovigen WHERE email = ? OR user = ? OR contact = ?");
            ...
            PreparedStatement insertStmt = cn.prepareStatement("INSERT INTO jovigen (email,contact,user,pass,status) VALUES (?,?,?,?,'Active')");
